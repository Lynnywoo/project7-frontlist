/*
 * @file testerAsA.cpp
 * @brief Driver program that tests FrontListAsA (private inheritance / as-a).
...
// prints front item and list length
template<class ItemType>
void displayFront(const FrontListAsA<ItemType>& fl, const std::string& label)
{
    std::cout << label;
    if (fl.isEmpty())
...
{
    std::cout << "========================================\n";
    std::cout << "  Testing FrontListAsA (as-a / private inheritance)\n";
    std::cout << "========================================\n\n";
    ...
    // compile-time enforcement note 
    std::cout << "--- private inheritance compile-time enforcement ---\n";
    std::cout << "Positional insert(int,T), remove(int), and replace(int,T)\n";
    std::cout << "are inaccessible to clients at COMPILE TIME because of\n";
    std::cout << "private inheritance.  No runtime test is needed or possible.\n\n";

    std::cout << "========================================\n";
    std::cout << "  FrontListAsA tests complete.\n";
    std::cout << "========================================\n";
